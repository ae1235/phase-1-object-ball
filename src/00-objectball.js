...
function playerNumbers(teamName) {
    ...
    for(teamKey in statistics) {
        if(statistics[teamKey]["teamName"] === teamName) {
            for(playerKey in statistics[teamKey]["players"]) {
                playerNumberList.push(statistics[teamKey]["players"][playerKey]["number"])
                }
            }
        }
...
function mostPointsScored() {
    ...
    for(teamKey in statistics) {
        for(playerKey in statistics[teamKey]["players"]) {
            if(statistics[teamKey]["players"][playerKey]['points'] > mostPointsInfo.pointsScored) {
                mostPointsInfo.playerName = playerKey;
                mostPointsInfo.pointsScored = statistics[teamKey]["players"][playerKey]["points"];
                }
            }
        }
